...
const FACTS: { k: string; v: string }[] = [
  ...
  { k: 'СТЕК', v: 'React · Next.js · Node.js' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <br />
              <span className="text-muted">Дисциплина в каждой детали.</span>
            </h2>
            ...
            <div className="space-y-6 max-w-2xl text-ink-2 text-base md:text-lg leading-relaxed">
              ...
              <p data-reveal="3">
                Веду проект от идеи до запуска: понятные сроки, чистый код и
                поддержка после сдачи. Главное для меня — чтобы сайт работал
                на результат и приносил клиенту заявки.
              </p>
            </div>
